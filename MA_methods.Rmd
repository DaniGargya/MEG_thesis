...
\newpage
Table 2: The scales used to measure sustainability attitudes and sustainability behaviours based on the Theory of Planned Behaviour. Attitudes, subjective norms, perceived behavioural control and intentions were combined to form sustainability attitudes, and self-reported behaviours were taken as sustainability behaviours. The scales have been copied one to one from Pauli (2023). The questions here have been translated to English for consistency, see German version in Appendix A.
...
\newpage
Table 3: The scales used for efficacy beliefs were based on the Triple-A framework (Agent-Action-Aim) by Hamann et al. (2024). The scales allowed differentiation between personal and collective efficacy beliefs and between aim and action focus. The questions here have been translated to English for consistency, see German version in Appendix A.
